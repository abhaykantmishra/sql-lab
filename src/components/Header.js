        ...
        <header className="h-16 border-b border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 flex items-center px-6 justify-between sticky top-0 z-50">
            <div className="flex items-center gap-8">
                <Link href="/" className="flex items-center gap-2 hover:opacity-80 transition-opacity">
                    ...
                    <span className="font-bold text-xl tracking-tight text-zinc-900 dark:text-zinc-100">SQL Labs</span>
                </Link>
            ...
            <div className="flex items-center gap-4">
                ...
                <Link href="/signup" className="text-sm font-medium px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-md transition-colors flex items-center gap-2">
                    <UserPlus size={16} />
                    Sign Up
                </Link>
